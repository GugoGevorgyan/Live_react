  ...
  return (
    <div className={classes.authCover}>
      <div>
        ...
        <button onClick={() => handleClick("ko")}>русский</button>
            ...
            <form className={classes.root} noValidate autoComplete="off">
              <Grid container>
                <Grid item xs={12}>
                  <div className={classes.emailinputstyle}>
                    <TextField
                      ...
                      className={
                        email
                          ? classes.authInputStyleError
                          : classes.authInputStyle
                      }
                      autoComplete="email"
                      value={values.email}
                ...
                <Grid item xs={12}>
                  <div>
                    <FormControl
                      className={clsx(classes.margin, classes.authInputStyle)}
                    >
                      <InputLabel
                ...
                <Grid item xs={12}>
                  <div className={classes.forgot}>
                    <Typography variant="body2" className={classes.forgotStyle}>
                      Forgot password
                    </Typography>
                  </div>
                </Grid>
